<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    class="bi flex-shrink-0" :class="`bi-${name}`" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
...
defineProps<{ name: BootstrapIconName }>()
</script>
