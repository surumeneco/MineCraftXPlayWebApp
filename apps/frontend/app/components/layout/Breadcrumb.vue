<template>
  <nav aria-label="breadcrumb" class="xplay-breadcrumb mb-3">
    <button type="button" class="xplay-breadcrumb__back btn btn-sm btn-outline-secondary" aria-label="前のページに戻る" @click="goBack">
      <UiBootstrapIcon name="arrow-left" /> 戻る
    </button>
...
function goBack() {
  // A direct bookmark has no in-app predecessor: use the breadcrumb parent instead.
...
.xplay-breadcrumb__back { flex: 0 0 auto; display: inline-flex; align-items: center; gap: .35rem; }
