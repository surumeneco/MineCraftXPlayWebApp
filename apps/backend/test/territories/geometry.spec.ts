...
import { area, centroid, pointInPolygon, polygonDistance, polygonsOverlapArea, validateCoordinates } from '../../src/territory-geometry.js'
...
describe('territory geometry', () => {
  ...
  it('detects overlap and 32-block distance', () => {
